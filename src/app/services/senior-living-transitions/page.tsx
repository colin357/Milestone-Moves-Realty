    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-[#123A5E] py-24 px-4 text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <p className="text-white font-bold tracking-widest text-sm mb-4 uppercase">Senior Living Transitions</p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-[#123A5E] font-bold tracking-widest text-sm mb-3 uppercase">You&apos;re Not Alone in This</p>
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            {emotions.map((e) => (
              <span key={e} className="bg-[#f3f4f6] text-[#123A5E] font-semibold text-sm px-4 py-2 rounded-full">{e}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {communities.map((c) => (
              <div key={c.title} className="bg-white rounded-2xl p-7 shadow-sm border-l-4 border-[#123A5E]">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-[#123A5E] font-bold tracking-widest text-sm mb-3 uppercase">Every Moving Piece</p>
