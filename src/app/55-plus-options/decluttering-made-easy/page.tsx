...
export default function DeclutteringMadeEasy() {
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-[#1C2B5E] mb-4">The Three-Box Method</h2>
      <p className="text-[#3d3d3d] leading-relaxed mb-4">
        For every room, grab three boxes and label them:
      </p>
      <div className="grid sm:grid-cols-3 gap-4 mb-8">
        {[
          { label: "KEEP", color: "#1C2B5E", desc: "Items you love, use, and will bring to your new home." },
          { label: "DONATE / GIVE", color: "#2BB8D3", desc: "Items still useful to others — family, friends, or local charities." },
      ...
      <h2 className="text-2xl font-bold text-[#1C2B5E] mb-4">Room-by-Room Checklist</h2>
      <div className="space-y-4 mb-8">
        {[
          ...
          <div key={section.room} className="border-l-4 border-[#2BB8D3] pl-4">
            <h3 className="font-bold text-[#1C2B5E] mb-2">{section.room}</h3>
