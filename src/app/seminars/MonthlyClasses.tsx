  ...
  return (
    <div className="max-w-4xl mx-auto">
        ...
        {months.map((m, i) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-3 rounded-xl text-sm font-bold tracking-wide transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#123A5E] focus-visible:ring-offset-2 ${
                isActive
                  ? "bg-[#123A5E] text-white shadow-sm"
                  : "bg-white text-[#123A5E] border border-gray-200 hover:border-[#123A5E] hover:text-[#123A5E]"
              }`}
            >
      ...
      <div key={selected} className="animate-dropdown">
        {active.session ? (
          <div className="bg-gray-50 rounded-2xl shadow-sm border-t-4 border-[#123A5E] overflow-hidden">
            <div className="p-8 sm:p-10">
              <span className="inline-block bg-[#f3f4f6] text-[#123A5E] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4">
                {active.name} Class
              </span>
              ...
              <dl className="grid sm:grid-cols-3 gap-5 mb-8">
                <div className="flex gap-3 items-start">
                  <svg className="w-5 h-5 text-[#123A5E] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wider text-[#123A5E] mb-0.5">Date</dt>
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wider text-[#123A5E] mb-0.5">Time</dt>
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    <dt className="text-xs font-bold uppercase tracking-wider text-[#123A5E] mb-0.5">Location</dt>
                    <dd>
                      <a href={active.session.locationUrl} target="_blank" rel="noopener noreferrer" className="text-[#123A5E] font-semibold text-sm hover:underline">
              ...
              <a
                ...
                className="inline-block text-center bg-[#123A5E] hover:bg-[#0D2942] text-white font-bold px-8 py-3 rounded-full transition-colors text-sm tracking-wider"
              >
                REGISTER NOW
              </a>
            </div>
      ...
      <div className="mt-10 bg-[#f3f4f6] border border-[#123A5E] rounded-2xl p-6 text-center">
        ...
        <div className="mt-3 flex flex-col sm:flex-row gap-2 sm:gap-6 justify-center text-sm font-semibold">
          <a href="mailto:freda@milestonemoves.com" className="text-[#123A5E] hover:underline">freda@milestonemoves.com</a>
          <a href="tel:+19198109551" className="text-[#123A5E] hover:underline">919-810-9551</a>
        </div>
      </div>
    </div>
  );
