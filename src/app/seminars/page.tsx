...
export const metadata = {
  ...
  description:
    "Free educational classes for adults 55+ in the Triangle, NC — hosted by Freda Hamlett at senior centers in Cary and Fuquay-Varina.",
};
    ...
    <div>
      <section className="bg-[#123A5E] py-20 px-4 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">Free, no-pressure educational sessions for adults 55 and better — because confident decisions start with good information. Join us in Cary or Fuquay-Varina.</p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#3d3d3d] mt-4 max-w-xl mx-auto">Pick a month below to see Freda&apos;s remaining 2026 classes in Cary and Fuquay-Varina.</p>
          </div>
          <MonthlyClasses />
        </div>
      </section>
