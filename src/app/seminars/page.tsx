    ...
    <div>
      <section className="bg-[#123A5E] py-20 px-4 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed">Free, no-pressure educational sessions for adults 55 and better — because confident decisions start with good information. Join us at the Cary Senior Center.</p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#3d3d3d] mt-4 max-w-xl mx-auto">Freda hosts one educational class each month. Pick a month below to see what&apos;s scheduled and reserve your seat.</p>
          </div>
          <MonthlyClasses />
        </div>
      </section>
