  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-10">
        {/* Contact Info */}
        <div>
          <h2 className="text-2xl font-bold text-[#1C2B5E] mb-6">Get in Touch</h2>

          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              <div className="w-10 h-10 bg-[#2BB8D3] rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="font-bold text-[#1C2B5E]">Office Address</p>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <p className="font-bold text-[#1C2B5E]">Email</p>
                <a href="mailto:info@milestonemovesrealty.com" className="text-[#2BB8D3] hover:underline">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <p className="font-bold text-[#1C2B5E]">Phone</p>
                <p className="text-[#3d3d3d]">Contact us for our current number</p>
              </div>
            </div>
          </div>

          <div className="mt-8 bg-[#1C2B5E] text-white rounded-xl p-5">
        ...
        {/* Contact Form */}
        <div>
          <h2 className="text-2xl font-bold text-[#1C2B5E] mb-6">Send a Message</h2>
          <form className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-[#3d3d3d] mb-1">Full Name *</label>
              <input
                type="text"
                className="w-full border border-gray-300 rounded-lg px-4 py-3 text-[#3d3d3d] focus:outline-none focus:border-[#2BB8D3] focus:ring-1 focus:ring-[#2BB8D3]"
            ...
            <div>
              ...
              <select className="w-full border border-gray-300 rounded-lg px-4 py-3 text-[#3d3d3d] focus:outline-none focus:border-[#2BB8D3] focus:ring-1 focus:ring-[#2BB8D3]">
            ...
            <button
              type="submit"
              className="w-full bg-[#2BB8D3] hover:bg-[#1fa3bd] text-white font-bold py-4 rounded-full transition-colors text-sm tracking-wider"
            >
              SEND MESSAGE
            </button>
          </form>
